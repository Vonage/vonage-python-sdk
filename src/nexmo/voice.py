...
class Voice:
    ...
    def initiate_tts_prompt_call(self, params=None, **kwargs):
        return self._client.post(
            self._client.api_host(), "/tts-prompt/json", params or kwargs
        )
    ...
    def _jwt_signed_post(self, request_uri, params):
        ...
        return self._client.parse(
            ...
            self._client.session.post(
                uri, json=params, headers=self._client._headers()
            ),
        )
    ...
    def _jwt_signed_get(self, request_uri, params=None):
        ...
        return self._client.parse(
            ...
            self._client.session.get(
                uri, params=params or {}, headers=self._client._headers()
            ),
        )
    ...
    def _jwt_signed_put(self, request_uri, params):
        ...
        return self._client.parse(
            self._client.api_host(),
            self._client.session.put(uri, json=params, headers=self._client._headers()),
        )
    ...
    def _jwt_signed_delete(self, request_uri):
        ...
        return self._client.parse(
            self._client.api_host(),
            self._client.session.delete(uri, headers=self._client._headers()),
        )
