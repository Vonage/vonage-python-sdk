...
class Client:
    ...
    def get_balance(self):
        return self.get(self.__host, "/account/get-balance")

    def get_country_pricing(self, country_code):
        return self.get(
            self.__host, "/account/get-pricing/outbound", {"country": country_code}
        )

    def get_prefix_pricing(self, prefix):
        return self.get(
            self.__host, "/account/get-prefix-pricing/outbound", {"prefix": prefix}
        )

    def get_sms_pricing(self, number):
        return self.get(
            self.__host, "/account/get-phone-pricing/outbound/sms", {"phone": number}
        )

    def get_voice_pricing(self, number):
        return self.get(
            self.__host, "/account/get-phone-pricing/outbound/voice", {"phone": number}
        )

    def update_settings(self, params=None, **kwargs):
        return self.post(self.__host, "/account/settings", params or kwargs)

    def topup(self, params=None, **kwargs):
        return self.post(self.__host, "/account/top-up", params or kwargs)

    def get_account_numbers(self, params=None, **kwargs):
        return self.get(self.__host, "/account/numbers", params or kwargs)

    def get_available_numbers(self, country_code, params=None, **kwargs):
        return self.get(
            self.__host, "/number/search", dict(params or kwargs, country=country_code)
        )

    def buy_number(self, params=None, **kwargs):
        return self.post(self.__host, "/number/buy", params or kwargs)

    def cancel_number(self, params=None, **kwargs):
        return self.post(self.__host, "/number/cancel", params or kwargs)

    def update_number(self, params=None, **kwargs):
        return self.post(self.__host, "/number/update", params or kwargs)

    def get_message(self, message_id):
        return self.get(self.__host, "/search/message", {"id": message_id})

    def get_message_rejections(self, params=None, **kwargs):
        return self.get(self.__host, "/search/rejections", params or kwargs)

    def search_messages(self, params=None, **kwargs):
        return self.get(self.__host, "/search/messages", params or kwargs)

    def send_ussd_push_message(self, params=None, **kwargs):
        return self.post(self.__host, "/ussd/json", params or kwargs)

    def send_ussd_prompt_message(self, params=None, **kwargs):
        return self.post(self.__host, "/ussd-prompt/json", params or kwargs)

    def send_2fa_message(self, params=None, **kwargs):
        return self.post(self.__host, "/sc/us/2fa/json", params or kwargs)

    def send_event_alert_message(self, params=None, **kwargs):
        return self.post(self.__host, "/sc/us/alert/json", params or kwargs)

    def send_marketing_message(self, params=None, **kwargs):
        return self.post(self.__host, "/sc/us/marketing/json", params or kwargs)

    def get_event_alert_numbers(self):
        return self.get(self.__host, "/sc/us/alert/opt-in/query/json")
    ...
    def get_standard_number_insight(self, params=None, **kwargs):
        return self.get(self.__api_host, "/ni/standard/json", params or kwargs)
    ...
    def get_number_insight(self, params=None, **kwargs):
        ...
        return self.get(self.__api_host, "/number/lookup/json", params or kwargs)

    def get_async_advanced_number_insight(self, params=None, **kwargs):
        argoparams = params or kwargs
        if "callback" in argoparams:
            return self.get(self.__api_host, "/ni/advanced/async/json", params or kwargs)
        else:
    ...
    def get_advanced_number_insight(self, params=None, **kwargs):
        return self.get(self.__api_host, "/ni/advanced/json", params or kwargs)

    def request_number_insight(self, params=None, **kwargs):
        return self.post(self.__host, "/ni/json", params or kwargs)
    ...
    def get_applications(self, params=None, **kwargs):
        ...
        return self.get(self.__api_host, "/v1/applications", params or kwargs)
    ...
    def create_application(self, params=None, **kwargs):
        ...
        return self.post(self.__api_host, "/v1/applications", params or kwargs)
    ...
    def redact_transaction(self, id, product, type=None):
        ...
        if type is not None:
            params["type"] = type
        return self._post_json(self.__api_host, "/v1/redact/transaction", params)
    ...
    def create_secret(self, api_key, secret):
        ...
        return self._post_json(
            self.__api_host, "/accounts/{api_key}/secrets".format(api_key=api_key), body
        )
