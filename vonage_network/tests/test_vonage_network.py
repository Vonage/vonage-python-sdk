...
from vonage_network._version import __version__

from vonage_network import Auth, VonageNetwork


def test_create_vonage_class_instance():
    vonage = VonageNetwork(Auth(api_key='asdf', api_secret='qwerasdf'))
    ...
    assert f'vonage-network-python-sdk/{__version__}' in vonage.http_client.user_agent
